<template>
  <v-dialog theme="dark" v-model="$store.state.media.show" width="90%">
    <v-card height="90vh">
      <div
      ...
      >
        ...
        <div class="flex-grow-1 d-flex flex-column">
          <v-card-title
            ...
            v-if="$store.state.media.music.name"
          >
      ...
      <v-card-text class="d-flex align-stretch">
        <div class="flex-grow-1">AAAA</div>
        <div>EEEE</div>
      </v-card-text>

      <v-card-actions class="align-stretch">
        <div class="d-flex flex-column flex-grow-1 px-2">
          <div class="d-flex align-center justify-center flex-grow-1">
            ...
            <list-change-music-type
              v-if="
                !$store.state.media.loading && $store.state.media.audio <= 0
              "
